...
(function(global){
  ...
  function appendLine(text, isError){
    ...
    lines.forEach(function(ln){
      ...
      try{ div.innerHTML = window.ansiParser.toHtml(ln); }
      catch(e){ div.textContent = ln; }
  ...
  global.console = {
    log: function(){ var args = Array.prototype.slice.call(arguments); global.__origConsole.log.apply(global.__origConsole, args); appendLine(args.map(a=>typeof a==='object'?JSON.stringify(a):String(a)).join(' '), false); },
    info: function(){ var args = Array.prototype.slice.call(arguments); global.__origConsole.info.apply(global.__origConsole, args); appendLine(args.map(a=>typeof a==='object'?JSON.stringify(a):String(a)).join(' '), false); },
    warn: function(){ var args = Array.prototype.slice.call(arguments); global.__origConsole.warn.apply(global.__origConsole, args); appendLine(args.map(a=>typeof a==='object'?JSON.stringify(a):String(a)).join(' '), true); },
    error: function(){ var args = Array.prototype.slice.call(arguments); global.__origConsole.error.apply(global.__origConsole, args); appendLine(args.map(a=>typeof a==='object'?JSON.stringify(a):String(a)).join(' '), true); },
    debug: function(){ var args = Array.prototype.slice.call(arguments); global.__origConsole.debug.apply(global.__origConsole, args); appendLine(args.map(a=>typeof a==='object'?JSON.stringify(a):String(a)).join(' '), false); }
  };
